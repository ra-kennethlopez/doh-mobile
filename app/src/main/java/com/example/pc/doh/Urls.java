...
//    public static String  server = "https://olrs.rightapps.solutions/";
    ...
    //https://doholrs.infoadvance.com.ph/employee/dashboard/processflow/assessment/
    public static String employee = server + "employee/forMobile/true";
    public static String forgot =  server +"employee/forgot/";
    public static String assessment = server + "employee/dashboard/processflow/assessment/";
    ...
    public static String sendevaluate = server + "employee/dashboard/processflow/evaluation/view/";
    //public static String sendassessment = server + "employee/dashboard/processflow/SaveAssessmentsMobile/8c4ec756c0b63a005843002be03e068c";
    public static String sendassessment = server + "employee/dashboard/processflow/SaveInspection/Mobile";
    public static String getcount = server + "employee/dashboard/processflow/floorPlan/revisionLastCount/";
    public static String geteparts = server + "employee/dashboard/processflow/floorPlan/parts/";
    //"http://192.168.254.99:8080/doholrs4/employee/dashboard/processflow/assessment/17/SURV/H2
    //doholrs/employee/dashboard/processflow/parts/177
    //
}
