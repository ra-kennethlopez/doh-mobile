...
public class MonitorHeaderOne extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        header.setText(MonitoringPart.desc);
        tooltitle = findViewById(R.id.toolbar_title);
        tooltitle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent headerone = new Intent(getApplicationContext(), MonitoringPart.class);
                startActivity(headerone);
                Animatoo.animateSlideRight(MonitorHeaderOne.this);
            }
        });
...
//        }
        ...
        hAdapter.setonItemClickListener(new HeadersAdapter.onItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                startActivity(headerone);
                Animatoo.animateSlideLeft(MonitorHeaderOne.this);
    ...
    private void build_menu(){
        Cursor det = db.get_itemMon("tbl_assessment_part", MonitoringActivity.appid, MonitoringActivity.type);
                ...
                try {
                    ...
                    if(head.length()>0){
                        for(int i =0;i<head.length();i++){
                            ...
                            if(MonitoringPart.id.equals(id)){
                                plist.add(new headerone(id,desc,i+""));
                                SubMenu sub = menu.getMenu().addSubMenu(i,i,1,desc);
                                Cursor hdet = db.get_itemsMon("tbl_assessment_headerone", id,MonitoringActivity.appid,MonitoringActivity.type);
    ...
    private void get_headerone_online(){
        ...
        StringRequest request = new StringRequest(Request.Method.POST, Urls.getheaderone+MonitoringActivity.appid+"/"+MonitoringPart.id+"/"+MonitoringActivity.type,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            JSONArray head = obj.getJSONArray("head");
                            int countassess = 0;
                            String honeid = db.gethoneid(MonitoringActivity.appid,MonitoringActivity.type,MonitoringPart.id);
                            ...
                            if (db.checkDatas("tbl_assessment_headerone", "honeid", honeid)){
                                ...
                                String[] datas = {response, uid, MonitoringActivity.appid,MonitoringPart.id,MonitoringActivity.type};
                            ...
                            if(head.length()>0){
                                for(int i =0;i<head.length();i++){
                                    String id = head.getJSONObject(i).getString("id");
                                    String desc =head.getJSONObject(i).getString("desc");
                                    String hid = db.get_tbl_assessment_headermon(MonitoringActivity.appid,uid,id,"1",MonitoringActivity.type);
                                    String assess = "false";
                                    if (db.checkDatas("tbl_save_assessment_header", "assessheadid", hid)){
                                        countassess++;
                                        assess = db.get_tbl_assessment_header_assessmon(MonitoringActivity.appid,uid,id,"1",MonitoringActivity.type);
                                    }
...
//                            }
    ...
    private void save_assessment_header(){
        //get_tbl_assessment_headermon(String appid,String uid,String headid,String headerlevel,String monid)
        String id = db.get_tbl_assessment_headermon(MonitoringActivity.appid,uid,MonitoringPart.id,"0",MonitoringActivity.type);
        if (db.checkDatas("tbl_save_assessment_header", "assessheadid", id)){
        }else{
            String[] dcolumns = {"headerid", "headerlevel", "assess","appid","uid","monid"};
            String[] datas = {MonitoringPart.id,"0","true",MonitoringActivity.appid,uid,MonitoringActivity.type};
        ...
        expandableListView.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            ...
            public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                ...
                switch (headerList.get(groupPosition).index){
                    case 4:
                        Intent main = new Intent(MonitorHeaderOne.this,MainActivity.class);
                        startActivity(main);
